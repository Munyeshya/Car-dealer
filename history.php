...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      <div class="container">
        <h2 class="mb-4">Complete Payments on Retailed cars</h2>
        <div class="row">

          <!-- First Card -->
          <?php
          $fetch=$conn->query("SELECT *from cars where status='2' OR status='3' ");
              ...
              <div class="card-body">
                <div class="row">
                 <div class="col-md-4">
                    ...
                    <a href="delete2.php?id=<?php echo $m['id']?>"> <i class="fa fa-times-circle-o text-dark"></i> </a> 
                    </p>
                  <?php }?>
                  ...
                  <div class="col-md-4">
                    ...
                    <form method="post" action="action.php?id=<?php echo $id?> ">
                      ...
                      <button type="submit" name="compe" class="btn btn-dark btn-sm w-100 mb-1">Complete Payment</button>
                    </form>
                    <?php
                     }else{
                    ?>
